...
/**
 * Class to represent list information.
 */
public final class ListElement extends AbstractElement {
    private final List<IElement> value;

    /**
     * Basic constructor.
     * @param value Value information.
     */
    public ListElement(List<IElement> value) {
        this.value = value;
    }

    @Override
    public List<IElement> getValue() {
        return this.value;
    }
