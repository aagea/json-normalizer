...
public final class ListNormalData extends AbstractNormalData {
    private final List<INormalData> value;

    public ListNormalData(List<INormalData> value) {
        this.value = value;
    }

    @Override
    public List<INormalData> getValue() {
        return this.value;
    }
