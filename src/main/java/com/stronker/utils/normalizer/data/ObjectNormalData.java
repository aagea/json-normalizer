...
public final class ObjectNormalData extends AbstractNormalData {
    private final List<RawData> value;

    public ObjectNormalData(List<RawData> value) {
        this.value = value;
    }

    @Override
    public List<RawData> getValue() {
        return this.value;
    }
