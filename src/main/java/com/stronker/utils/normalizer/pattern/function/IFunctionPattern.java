...
/**
 * Interface to launch transformation.
 */
public interface IFunctionPattern {
    /**
     * Transform raw data in Normalized data only if you pass the match patterns.
     *
     * @param rawData Not normalized data.
     * @return Normalized data.
     */
    NormalizedData call(RawData rawData);
}
