...
/**
 * Factory of IFunctionPattern.
 */
public interface IFunctionPatternFactory {
    /**
     * Get a new instance from IFunctionPattern.
     *
     * @return Instance of IFunctionPattern.
     */
    IFunctionPattern getInstance();
}
