...
public class ToStringPatternFunctionFactory implements IPatternFunctionFactory {

    public ToStringPatternFunctionFactory() {

    }

    @Override
    public IPatternFunction getInstance() {
        return new ToStringPatternFunction();
    }

    private static final class ToStringPatternFunction implements IPatternFunction {
        private ToStringPatternFunction() {
