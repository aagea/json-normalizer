...
/**
 * Helper to build name pattern.
 */
public abstract class AbstractNamePattern implements INamePattern {
     ...
     */
    public AbstractNamePattern(String pattern) {
