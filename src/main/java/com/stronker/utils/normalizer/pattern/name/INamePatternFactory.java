...
/**
 * Interface for name pattern factory.
 */
public interface INamePatternFactory {
    /**
     * Get a new instance of INamePattern.
     *
     * @param pattern Compare pattern.
     * @return New instance of INamePattern.
     */
    INamePattern getInstance(String pattern);
}
