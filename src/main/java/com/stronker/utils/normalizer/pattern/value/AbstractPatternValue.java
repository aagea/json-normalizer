...
public abstract class AbstractPatternValue implements IPatternValue {
    private final String pattern;

    public AbstractPatternValue(String pattern) {
        this.pattern = pattern;
    }

    @Override
    public abstract boolean match(INormalData value);
