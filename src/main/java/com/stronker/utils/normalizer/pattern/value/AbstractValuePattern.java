...
/**
 * Helper to build ValuePattern classes.
 */
public abstract class AbstractValuePattern implements IValuePattern {
     ...
     */
    public AbstractValuePattern(String pattern) {
        this.pattern = pattern;
    }

    @Override
    public abstract boolean match(IElement value);
