...
/**
 * Interface to ValuePattern factories.
 */
public interface IValuePatternFactory {
    /**
     * Get a new instance of ValuePattern.
     * @param pattern Compare pattern.
     * @return New instance of ValuePattern.
     */
    IValuePattern getInstance(String pattern);
}
